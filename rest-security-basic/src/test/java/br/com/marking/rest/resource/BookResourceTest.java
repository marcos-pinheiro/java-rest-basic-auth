...
public class BookResourceTest {
    ...
    private static final String TARGET      = "http://localhost:8080/rest-security-basic/rest/books";
    ...
    public void testGetBookByIsbn() throws Exception {
        ...
        Book book = client
                .target(TARGET)
                .path("/{isbn}")
                .resolveTemplate("isbn", "0321356683")
   ...
   @Test
    public void testUpdate() {
        ...
        Response response = client
                .target(TARGET)
                .path("/{isbn}")
                .resolveTemplate("isbn", "0987654321")
                .register(newAuthenticator(USERNAME, PASSWORD))
                .request()
    ...
    public void testDelete() {
        ...
        Response response = client
                .target(TARGET)
                .path("/{isbn}")
                .resolveTemplate("isbn", "9999999999")
                .register(newAuthenticator(USERNAME, PASSWORD))
                .request()
                .delete();
